...
public class ArbitreDeLigne extends Arbitre {
   ...
   public Collection<MatchDouble> lesMatchs;
   ...
   public Collection<MatchDouble> getLesMatchs() {
      if (lesMatchs == null)
         lesMatchs = new HashSet<MatchDouble>();
      return lesMatchs;
   }
   ...
   /** @pdGenerated default setter
     * @param newLesMatchs */
   public void setLesMatchs(Collection<MatchDouble> newLesMatchs) {
      removeAllLesMatchs();
   ...
   public void addLesMatchs(MatchDouble newMatchDouble) {
      ...
      if (this.lesMatchs == null)
         this.lesMatchs = new HashSet<MatchDouble>();
