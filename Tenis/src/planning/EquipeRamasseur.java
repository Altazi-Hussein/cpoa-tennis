...
public class EquipeRamasseur {
   ...
   public Collection<RamasseurDeBalle> getIdquipe() {
      if (idquipe == null)
         idquipe = new HashSet<RamasseurDeBalle>();
      return idquipe;
   }
   
   /** @pdGenerated default iterator getter */
   public Iterator getIteratorIdquipe() {
      if (idquipe == null)
         idquipe = new HashSet<RamasseurDeBalle>();
   ...
   /** @pdGenerated default setter
     * @param newIdquipe */
   public void setIdquipe(Collection<RamasseurDeBalle> newIdquipe) {
      removeAllIdquipe();
      for (Iterator iter = newIdquipe.iterator(); iter.hasNext();)
   ...
   public void addIdquipe(RamasseurDeBalle newRamasseurDeBalle) {
      ...
      if (this.idquipe == null)
         this.idquipe = new HashSet<RamasseurDeBalle>();
   ...
   public void removeAllIdquipe() {
      if (idquipe != null)
      {
         ...
         for (Iterator iter = getIteratorIdquipe(); iter.hasNext();)
         {
   ...
   /** @pdGenerated default getter */
   public Collection<MatchDouble> getLesMatchsDouble() {
      if (lesMatchsDouble == null)
         lesMatchsDouble = new HashSet<MatchDouble>();
      return lesMatchsDouble;
   }
   
   /** @pdGenerated default iterator getter */
   public Iterator getIteratorLesMatchsDouble() {
      if (lesMatchsDouble == null)
         lesMatchsDouble = new HashSet<MatchDouble>();
   ...
   public void setLesMatchsDouble(Collection<MatchDouble> newLesMatchsDouble) {
      removeAllLesMatchsDouble();
      for (Iterator iter = newLesMatchsDouble.iterator(); iter.hasNext();)
   ...
   public void addLesMatchsDouble(MatchDouble newMatchDouble) {
      ...
      if (this.lesMatchsDouble == null)
         this.lesMatchsDouble = new HashSet<MatchDouble>();
   ...
   /** @pdGenerated default getter */
   public Collection<MatchSimple> getLesMatchsSimple() {
      if (lesMatchsSimple == null)
         lesMatchsSimple = new HashSet<MatchSimple>();
      return lesMatchsSimple;
   }
   
   /** @pdGenerated default iterator getter */
   public Iterator getIteratorLesMatchsSimple() {
      if (lesMatchsSimple == null)
         lesMatchsSimple = new HashSet<MatchSimple>();
   ...
   public void setLesMatchsSimple(Collection<MatchSimple> newLesMatchsSimple) {
      removeAllLesMatchsSimple();
      for (Iterator iter = newLesMatchsSimple.iterator(); iter.hasNext();)
   ...
   public void addLesMatchsSimple(MatchSimple newMatchSimple) {
      ...
      if (this.lesMatchsSimple == null)
         this.lesMatchsSimple = new HashSet<MatchSimple>();
